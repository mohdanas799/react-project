    ...
    <div className='w-full h-screen bg-zinc-900 pt-1'>
        <div className="textstructure mt-52 px-20">
            {["We Created", "Eye Opening", "Presentations"].map((item, index)=>{
               ...
               <h1 className='pt-[2vw] -mb-[1vw] uppercase text-[9vw] leading-[7vw]  font-["Founders_Grotesk"] font-bold'> 
               {item}
             </h1>
           </div>
           </div>
        ...
        <div className="border-t-[1px] border-zinc-800 mt-[3.2vw] flex justify-between items-center py-5 px-20">

     ...
     <div className="relative w-full h-full bg-cover bg-center bg-[url('https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg')]">
        <div className="absolute flex gap-10 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]  ">
            ...
            <div className="w-2/3 h-2/3 relative items-center justify-center rounded-full bg-zinc-900">
              <div style={{transform: `translate(-50%, -50%) rotate(${rotate}deg)`}} className="line  absolute w-full top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]  h-10 ">
            <div className="w-1/4 h-10 rounded-full bg-zinc-100">
              </div>
              </div>
               </div>
            </div>
